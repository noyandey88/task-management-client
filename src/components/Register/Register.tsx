      ...
      <div className="container flex flex-col items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          <div className="relative flex items-center mt-4">
            ...
            <input onChange={handlePasswordChange} type="password" className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" />
          </div>
          <div className="mt-6">
        ...
        <div>
          <div>
            <button onClick={handleGoogleRegister} className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-500 dark:text-white">
            ...
            <div className="mt-6 text-center dark:text-white">
              <p>Already have an account?
                <Link to="/login" className="text-sm font-medium text-blue-500 hover:underline dark:text-indigo-400">
                  Login
                </Link>
              </p>
            </div>
